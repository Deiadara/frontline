...
| `plate-bar.webp`               | Board delivery, `images/bar-portrait-3780x1800.png`  | Frontline board | Proprietary: owned | Yes           | No                   | 2026-08-28 | The Bar's room, repainted at 21:10. The old 1264×848 filled the frame by discarding a third of the painting; at this shape the whole room is on screen. The Sit Down control is a fraction of this exact image, so a crop moves the empty stool out from under it.                                                                                                                                             |
