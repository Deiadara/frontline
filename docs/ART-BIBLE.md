...
| `plate-bar.webp`               | Board delivery, `images/bar-portrait.png` | Frontline board | Proprietary: owned | Yes           | No                   | 2026-08-27 | The Bar's room. Ships at the painted 1264×848 rather than the plate class's 2048×1152: the Sit Down control is a fraction of this image, so a crop moves the empty stool out from under it.                                              |
