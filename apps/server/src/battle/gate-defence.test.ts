...
async function register(
  ...
  // The measurement is a subtraction across two worlds, so both crews have to be the same person:
  // a signature perk on one side and not the other lands in the difference as if it were the Gate.
