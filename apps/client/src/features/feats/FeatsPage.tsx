  ...
  return (
    ...
    <PageShell fills wide quote="Evidence that you were here.">
      ...
      {skipped.length > 0 && (
        ...
        >
          {/* Two reasons a rung can be passed over now (maintainer, 2026-09-23): nowhere to put
              the bodies, or no room in the stores for what it pays. The batch does not say which
              of the two it was per feat, and the answer to both is the same, so the line names
              both rather than guessing. */}
          {skipped.length} {skipped.length === 1 ? 'feat is' : 'feats are'} still waiting: there is
          no room for what {skipped.length === 1 ? 'it pays' : 'they pay'}. Make space in the
