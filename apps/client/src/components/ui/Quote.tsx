  ...
  return (
    <figure className={cn('min-w-0', className)}>
      <blockquote>
         ...
         * quotation mark nearly twice the size of the words it opens.
         *
         * They are `inline-block` at zero leading, which is what stops them setting the line
         * height. A 44px glyph in a 19px line is a 44px line box, so a quotation that happened to
         * wrap came out with a finger's width of air between its two lines and read as two
         * separate sentences. Zero-height boxes let the glyphs overhang instead, and the paragraph
         * keeps the leading it was set at.
         */}
        <p className="font-stamp text-[19px] italic leading-[1.35] text-brass-100">
          <span
            aria-hidden
            className="mr-0.5 inline-block align-[-0.2em] text-[34px] not-italic leading-[0] text-brass-300/60"
          >
            “
          </span>
          {children}
          <span
            aria-hidden
            className="ml-0.5 inline-block align-[-0.3em] text-[34px] not-italic leading-[0] text-brass-300/60"
          >
            ”
          </span>
        </p>
